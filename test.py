...
GOOD_PAIRS = [
    ...
    ("[x]", x),
    ("[a + b]", _Add(a, b)),
    ("\\left(a + b\\right)", _Add(a, b)),
    ("\\left[a + b\\right]", _Add(a, b)),
    ("\\bigl(a + b\\bigr)", _Add(a, b)),
